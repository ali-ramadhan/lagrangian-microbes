...
particle_lons, particle_lats = uniform_particle_locations(N_particles=1000,
                                                          lat_min=25, lat_max=35,
                                                          lon_min=205, lon_max=215)

p = ParticleAdvecter(particle_lons, particle_lats, N_procs=1, output_dir="/home/gridsan/aramadhan/microbes_output/")
