...
output_dir = os.path.join("/home", "alir", "nobackup", "lagrangian_microbe_output", "rps_small_patch_490kp")
...
NTx, NTy = 100, 175  # number of microbes in each tile (x and y directions)
...
INTERACTION_LENGTH_SCALE = 0.005  # degrees lol...
INTERACTION_NORM = 2
INTERACTION_p = 0.9
